...
QStringList Logger::getDebugMessages(){
    return instance()->debugMsgs;
}

QStringList Logger::getWarningMessages(){
    return instance()->warningMsgs;
}

QStringList Logger::getCriticalMessages(){
    return instance()->criticalMsgs;
}

QStringList Logger::getFatalMessages(){
    return instance()->fatalMsgs;
}

QStringList Logger::getInfoMessages(){
    return instance()->infoMsgs;
}

QStringList Logger::getMessages(){
